...
import pl.antonic.partify.list.adapters.PlaylistTracksListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        call.enqueue(object : Callback<Recommendations> {
            ...
            override fun onResponse(call: Call<Recommendations>, response: Response<Recommendations>) {
                ...
                val adapter = PlaylistTracksListAdapter(this@PlaylistActivity, ObjectList(recommendations.tracks!!))
        ...
        call.enqueue(object : Callback<User> {
            ...
            override fun onResponse(call: Call<User>, response: Response<User>) {
                ...
                val secondCall = apiService.createPlaylist("Bearer " + TokenService.retrieve(this@PlaylistActivity),
                    user.id!!, CreatePlaylistData("Partify-" + user.display_name + " " + System.currentTimeMillis()))
